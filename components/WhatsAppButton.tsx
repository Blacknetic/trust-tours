...
function buildUrl(pathname: string): string {
  ...
  if (segments.length >= 2) {
    ...
    if (pkg) {
      message = `Hi Ombeni! I'm interested in the ${pkg.title}. Can you send me the itinerary and pricing?`;
    }
  } else if (segments[0] === "kilimanjaro") {
    message =
      "Hi Ombeni! I'm interested in climbing Kilimanjaro with Trust Tours. What routes do you recommend?";
  } else if (segments[0] === "safaris") {
    message =
      "Hi Ombeni! I'm interested in a Tanzania safari with Trust Tours. Can you share options?";
  } else if (segments[0] === "trekking") {
    message =
      "Hi Ombeni! I'm interested in trekking in Tanzania with Trust Tours.";
  }
