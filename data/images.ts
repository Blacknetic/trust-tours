...
const BY_DESTINATION: Partial<Record<Destination, string[]>> = {
  Kilimanjaro: [
    ...
    I("kilimanjaro-summit-sunrise.jpg"),
    I("kilimanjaro-porters.jpg"),
    I("kilimanjaro-camp.jpg"),
    I("kilimanjaro-summit-sign.jpg"),
  ],
  ...
  Ngorongoro: [I("ngorongoro-rhino.jpg"), I("safari-lion-pride.jpg"), I("safari-lioness.jpg"), I("serengeti-cheetah.jpg")],
  Tarangire: [I("tarangire-giraffes.jpg"), I("safari-elephant.jpg"), I("safari-acacia-sunset.jpg"), I("safari-giraffes.jpg")],
  "Lake Manyara": [I("manyara-flamingos.jpg"), I("safari-hippo.jpg")],
  Zanzibar: [
    I("zanzibar-beach.jpg"),
    I("zanzibar-2.jpg"),
    I("zanzibar-resort.jpg"),
    I("zanzibar-dhow.jpg"),
    I("zanzibar-pool.jpg"),
    I("zanzibar-snorkeling.jpg"),
  ],
...
const BY_CATEGORY: Record<TripPackage["category"], string[]> = {
  ...
  safari: [
    ...
    I("safari-elephant.jpg"),
    I("safari-lioness.jpg"),
